...
namespace Camply.Infrastructure.Migrations
{
    ...
    [Migration("20250610075045_AddMlTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Camply.Domain.MachineLearning.MLContentFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<float?>("ViralPotential")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("ViralPotential")
                        .HasDatabaseName("ix_ml_content_features_viral");

                    b.HasIndex("ContentId", "ContentType", "FeatureCategory")
                        .HasDatabaseName("ix_ml_content_features_content_category");

                    b.ToTable("ml_content_features", (string)null);
                });

            modelBuilder.Entity("Camply.Domain.MachineLearning.MLExperiment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ControlConfig")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<float?>("StatisticalSignificance")
                        .HasColumnType("real");
                    ...
                    b.ToTable("ml_experiments", (string)null);
                });

            modelBuilder.Entity("Camply.Domain.MachineLearning.MLModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TrainingDataInfo")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Camply.Domain.MachineLearning.MLTrainingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ml_training_jobs", (string)null);
                });

            modelBuilder.Entity("Camply.Domain.MachineLearning.MLUserExperiment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ml_user_experiments", (string)null);
                });

            modelBuilder.Entity("Camply.Domain.MachineLearning.MLUserFeature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "FeatureType", "Version")
                        .HasDatabaseName("ix_ml_user_features_user_type_version");

                    b.ToTable("ml_user_features", (string)null);
                });
            ...
            modelBuilder.Entity("Camply.Domain.MachineLearning.MLTrainingJob", b =>
                {
                    b.HasOne("Camply.Domain.MachineLearning.MLModel", "Model")
                        .WithMany()
            ...
            modelBuilder.Entity("Camply.Domain.MachineLearning.MLUserExperiment", b =>
                {
                    b.HasOne("Camply.Domain.MachineLearning.MLExperiment", "Experiment")
                        .WithMany()
